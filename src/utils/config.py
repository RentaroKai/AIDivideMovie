...
class ModelsConfig(BaseModel):
    """AIモデル名設定モデル"""
    gemini_transcription: str = "gemini-2.5-flash-preview-05-20"
    gemini_minutes: str = "gemini-2.5-flash-preview-05-20"
    gemini_title: str = "gemini-2.5-flash-preview-05-20"
